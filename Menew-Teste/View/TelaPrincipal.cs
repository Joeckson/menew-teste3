...
namespace Menew_Teste
{
    public partial class Form1 : Form
    {
        ...
        private void BtSalvar_Click(object sender, EventArgs e)
        {
            ...
            if (id == 0)
            {
                if (txtCep.Text.Equals("") || txtCidade.Text.Equals("") ||
                txtEmail.Text.Equals("") || txtEstado.Text.Equals("") || txtNome.Text.Equals("") ||
                txtNumero.Text.Equals("") || txtRua.Text.Equals("") || txtTelefone.Text.Equals("")
                )
                {
                    MessageBox.Show("Existe campo vazio!", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
        ...
        private void TBUsuario_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            txtNumero.Text = this.TBUsuario.CurrentRow.Cells[9].Value.ToString();
        ...
        private void btExcluir_Click(object sender, EventArgs e)
        {
            if (id != 0)
            {
                ...
                if (MessageBox.Show("Deseja excluir este usuário?","Alerta",MessageBoxButtons.YesNo)==DialogResult.Yes) { 
            ...
            {
                MessageBox.Show("Selecione o usuário que deseja excluir!","Alerta",MessageBoxButtons.OK,MessageBoxIcon.Information);
            }
        }
        ...
        //validando se exite algum campo vazio
        public void ValidCamp()
        {
            if (txtCep.Text.Equals("")||txtCidade.Text.Equals("")||
                txtEmail.Text.Equals("")||txtEstado.Text.Equals("")||txtNome.Text.Equals("")||
                txtNumero.Text.Equals("")||txtRua.Text.Equals("")||txtTelefone.Text.Equals("")
